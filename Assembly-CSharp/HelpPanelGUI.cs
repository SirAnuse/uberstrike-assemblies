...
{
	// Token: 0x06000CD8 RID: 3288 RVA: 0x00058120 File Offset: 0x00056320
	private void Start()
	{
		this._helpTabs = new GUIContent[]
		{
	...
	// Token: 0x06000CD9 RID: 3289 RVA: 0x00058170 File Offset: 0x00056370
	private void OnGUI()
	{
		int num = Mathf.RoundToInt((float)(Screen.height - 56) * 0.75f);
		this._rect = new Rect((float)(Screen.width - 630) * 0.5f, (float)GlobalUIRibbon.Instance.Height(), 630f, (float)num);
	...
	// Token: 0x06000CE0 RID: 3296 RVA: 0x000589EC File Offset: 0x00056BEC
	...
	// Token: 0x06000CE1 RID: 3297 RVA: 0x00058B44 File Offset: 0x00056D44
	private float DrawGroupColourReferences(float yOffset, string header)
	{
		...
		float num = rect.y + 16f;
		GUI.color = ColorScheme.ChatNameAdminUser;
		float num2 = BlueStonez.label_interparkbold_11pt_left_wrap.CalcHeight(new GUIContent("Administrators"), rect.width);
	...
	// Token: 0x06000CE2 RID: 3298 RVA: 0x000524D0 File Offset: 0x000506D0
	...
	// Token: 0x06000CE3 RID: 3299 RVA: 0x00058D9C File Offset: 0x00056F9C
	private int CurrentPlayers()
	{
		return this.currentPlayers + Mathf.RoundToInt((float)DateTime.Now.Subtract(this.baseTime).TotalSeconds * this.newPlayersPerSecond);
	}
