...
{
	// Token: 0x06000C28 RID: 3112 RVA: 0x00009490 File Offset: 0x00007690
	private void Awake()
	{
	...
	// Token: 0x06000C29 RID: 3113 RVA: 0x00050E7C File Offset: 0x0004F07C
	...
	// Token: 0x06000C2A RID: 3114 RVA: 0x00050EA8 File Offset: 0x0004F0A8
	private void Start()
	{
	...
	// Token: 0x06000C2D RID: 3117 RVA: 0x000094B3 File Offset: 0x000076B3
	...
	// Token: 0x06000C30 RID: 3120 RVA: 0x00051934 File Offset: 0x0004FB34
	...
	// Token: 0x06000C32 RID: 3122 RVA: 0x000094D4 File Offset: 0x000076D4
	...
	// Token: 0x06000C34 RID: 3124 RVA: 0x00051F80 File Offset: 0x00050180
	...
	// Token: 0x06000C35 RID: 3125 RVA: 0x00051FEC File Offset: 0x000501EC
	...
	// Token: 0x06000C36 RID: 3126 RVA: 0x000520FC File Offset: 0x000502FC
	...
	// Token: 0x06000C38 RID: 3128 RVA: 0x000094E1 File Offset: 0x000076E1
	...
	// Token: 0x06000C39 RID: 3129 RVA: 0x00052440 File Offset: 0x00050640
	private Rect CenteredAspectRect(float aspectRatio, int screenWidth, int screenHeight, int offsetTop, int minpWidth, int minHeight)
	{
		...
		if (num > aspectRatio)
		{
			...
			result = new Rect((float)(screenWidth - num2) * 0.5f, (float)offsetTop, (float)num2, (float)Mathf.Clamp(screenHeight, minHeight, 2048));
		}
		else
		{
			result = new Rect(0f, (float)offsetTop, (float)Mathf.Clamp(screenWidth, minpWidth, 2048), (float)Mathf.Clamp(Mathf.RoundToInt((float)screenWidth / aspectRatio), minHeight, 2048));
		}
		return result;
	}

	// Token: 0x06000C3A RID: 3130 RVA: 0x000524D0 File Offset: 0x000506D0
