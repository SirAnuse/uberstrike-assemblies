...
public class PlayerDataManager : Singleton<PlayerDataManager>
{
	...
	public static Color SkinColor
	{
		get
		{
			return Instance._localPlayerSkinColor;
		}
	}
	...
	public static string ClanName
	{
		get
		{
			return (Instance._playerClanData == null) ? string.Empty : Instance._playerClanData.Name;
		}
	}
	...
	public static string ClanTag
	{
		get
		{
			return (Instance._playerClanData == null) ? string.Empty : Instance._playerClanData.Tag;
		}
	}
	...
	public static string ClanMotto
	{
		get
		{
			return (Instance._playerClanData == null) ? string.Empty : Instance._playerClanData.Motto;
		}
	}
	...
	public static DateTime ClanFoundingDate
	{
		get
		{
			return (Instance._playerClanData == null) ? DateTime.Now : Instance._playerClanData.FoundingDate;
		}
	}
	...
	public static string ClanOwnerName
	{
		get
		{
			return (Instance._playerClanData == null) ? string.Empty : Instance._playerClanData.OwnerName;
		}
	}
	...
	public static int ClanMembersLimit
	{
		get
		{
			return (Instance._playerClanData == null) ? 0 : Instance._playerClanData.MembersLimit;
		}
	}
	...
	public int ClanMembersCount
	{
		get
		{
			return (_playerClanData == null) ? 0 : _playerClanData.Members.Count;
		}
	}
	...
	public static bool CanInviteToClan
	{
		get
		{
			return Instance.RankInClan == GroupPosition.Leader || Instance.RankInClan == GroupPosition.Officer;
		}
	}
